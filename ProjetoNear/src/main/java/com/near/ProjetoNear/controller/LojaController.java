...
public class LojaController {
	...
	public ModelAndView salvar(@Valid Loja cadastro, BindingResult result) throws Exception {
		if (result.hasErrors()) {
...
//		System.out.println(Util.md5(login.getSenha()));
	...
	public ModelAndView buscarCategoria(@RequestParam("categoria")String categoria, @RequestParam("bairro")String bairro) {
		ModelAndView mv = new ModelAndView("busca/categoria");
